from Err_eval_lib_GAN import LIBEROEval_err, build_visual_diffsuion_err
...
def get_args():
        ...
        parser.add_argument('--v_model_ckpt_path', default='', type=str, help='path to the checkpoint')
        parser.add_argument('--q_model_ckpt_path', default='', type=str, help='path to the checkpoint')
        parser.add_argument('--policy_ckpt_path', default='', type=str, help='path to the checkpoint')
        ...
        parser.add_argument('--ac_num', default=6, type=int, help='horizon for evaluation')
...
def main(args):
    ...
    policy = build_visual_diffsuion_err(args.policy_ckpt_path,args.v_model_ckpt_path, args.statistic_path, args.k, args.num_episodes)
    evaluator = LIBEROEval_err(task_suite_name='libero_goal', data_statistics=None, k=args.k, eval_horizon=args.eval_horizon, num_episodes=args.num_episodes)
